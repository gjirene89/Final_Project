...
//==============================================================================
bool CGameObjectBase::Initialize(ID3D11Device* device, char* modelFilename)
{
	bool result;
...
//          なし
//==============================================================================
void CGameObjectBase::Render(ID3D11DeviceContext* deviceContext, XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX projectionMatrix)
{
...
//==============================================================================
int CGameObjectBase::GetVertexCount()
{
...
//==============================================================================
int CGameObjectBase::GetIndexCount()
{
	return m_indexCount;
}
...
//==============================================================================
CTexture::TextureData CGameObjectBase::GetColorTexture()
{
...
//==============================================================================
CTexture::TextureData CGameObjectBase::GetBumpTexture()
{
...
//==============================================================================
CTexture::TextureData CGameObjectBase::GetSpecTexture()
{
...
//			bool	               true 成功　　       　false 失敗
//==============================================================================
bool CGameObjectBase::InitializeBuffers(ID3D11Device* device)
{
	VertexType* vertices;
...
//          なし
//==============================================================================
void CGameObjectBase::ShutdownBuffers()
{
	if (m_indexBuffer)
	{
...
//          なし
//==============================================================================
void CGameObjectBase::RenderBuffersIndex(ID3D11DeviceContext* deviceContext)
{
	unsigned int stride;
	unsigned int offset;
...
void CGameObjectBase::RenderBuffersIndex(ID3D11DeviceContext* deviceContext, ID3D11Buffer* vertexBuffer)
{
	unsigned int stride;
	unsigned int offset;
...
//			bool	true 成功　　　false 失敗
//==============================================================================
bool CGameObjectBase::LoadColorMap(ID3D11Device* device, ID3D11DeviceContext* deviceContext, char* filename)
{
	bool result;
...
//			bool	true 成功　　　false 失敗
//==============================================================================
bool CGameObjectBase::LoadColorMap(ID3D11Device* device, ID3D11DeviceContext* deviceContext, char* filename, int uRepeat, int vRepeat)
{
	bool result;
...
//			bool	true 成功　　　false 失敗
//==============================================================================
bool CGameObjectBase::LoadBumpMap(ID3D11Device* device, ID3D11DeviceContext* deviceContext, char* filename)
{
	bool result;
...
//			bool	true 成功　　　false 失敗
//==============================================================================
bool CGameObjectBase::LoadBumpMap(ID3D11Device* device, ID3D11DeviceContext* deviceContext, char* filename, int uRepeat, int vRepeat)
{
	bool result;
...
//			bool	true 成功　　　false 失敗
//==============================================================================
bool CGameObjectBase::LoadSpecMap(ID3D11Device* device, ID3D11DeviceContext* deviceContext, char* filename)
{
	bool result;
...
//			bool	true 成功　　　false 失敗
//==============================================================================
bool CGameObjectBase::LoadSpecMap(ID3D11Device* device, ID3D11DeviceContext* deviceContext, char* filename, int uRepeat, int vRepeat)
{
	bool result;
...
//          なし
//==============================================================================
void CGameObjectBase::ReleaseTexture()
{
	if (m_Texture)
	{
		m_Texture->Shutdown();
...
//			bool	true 成功　　　false 失敗
//==============================================================================
bool CGameObjectBase::LoadModel(char* filename)
{
	ifstream fin;
	char input;
	int i;
...
//          なし
//==============================================================================
void CGameObjectBase::ReleaseModel()
{
	if (m_model)
	{
		delete[] m_model;
